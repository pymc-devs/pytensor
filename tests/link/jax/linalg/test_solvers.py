...
from pytensor.tensor.linalg.decomposition import lu
from pytensor.tensor.linalg.decomposition.cholesky import cholesky
from pytensor.tensor.linalg.solvers import linear_control
from pytensor.tensor.linalg.solvers.general import lu_solve, solve
...
def test_bilinear_to_direct_rewrite(monkeypatch):
    ...
    monkeypatch.setattr(
        "pytensor.tensor.rewriting.linalg.solvers._load_solve_sylvester",

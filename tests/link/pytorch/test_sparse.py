...
def test_sparse_dot_constant_sparse(x_type, y_type, op):
    ...
    compare_pytorch_and_py(fgraph, test_values)
...
def test_sparse_dot_non_const_raises():
    ...
    msg = "PyTorch sparse dot only implemented for constant sparse inputs"

    with pytest.raises(NotImplementedError, match=msg):
        function([x_pt, y_pt], out, mode="PyTorch")
    ...
    with pytest.raises(NotImplementedError, match=msg):
        function([x_pt], out, mode="PyTorch")

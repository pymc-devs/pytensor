...
def test_reduction_operations_correctness(op_name, data):
    ...
    Total: 8 operations x 10 examples = 80 test scenarios
    """
    ...
    fn, _result = compare_onnx_and_py(graph_inputs, graph_output, [test_data[0]])
...
@pytest.mark.skip(
    reason="Boolean reduction operations (all/any) not yet fully supported in ONNX backend"
)

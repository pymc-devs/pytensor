...
class TestConvTypes:
    ...
    def test_grad_types(self):
        ...
        grad_input, grad_topgrad = pytensor.grad(grad_filters.sum(), wrt=(input, topgrad))
...
class TestUnsharedConv:
    ...
    def test_gradweight(self):
        ...
        for imshp, kshp, topshp, mode, sub, groups, verify in zip(
            ...
            ref_func = pytensor.function([img_sym, top_sym], ref_out_sym, mode=self.mode)
...
class TestAsymmetricPadding:
    ...
    def test_fwd(self):
        ...
        for imshp, kshp, pad in zip(self.img_shape, self.kern_shape, self.border_mode):
            ...
            ref_func = pytensor.function([img_sym, kern_sym], ref_out_sym, mode=self.mode)
    ...
    def test_gradinput(self):
        ...
        for imshp, kshp, topshp, pad in zip(
            ...
            ref_func = pytensor.function([kern_sym, top_sym], ref_out_sym, mode=self.mode)

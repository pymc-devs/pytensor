...
class XTypeCastOp(TypeCastingOp):
    ...
    def infer_shape(self, fgraph, node, input_shapes):
        # We don't want infer_shape to reintroduce xtensor variables in the graph.
        raise ShapeError(
            "infer_shape disabled for XTypeCast operation. It should be lowed to equivalent tensor operation first."
        )

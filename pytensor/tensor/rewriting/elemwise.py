...
class FusionOptimizer(GraphRewriter):
    ...
    def elemwise_to_scalar(inputs, outputs):
        ...
        # pytensor.dprint(outputs, print_type=True)
    ...
    def apply(self, fgraph):
        ...
        def find_next_fuseable_subgraph(
            ...
            while True:
                ...
                for starting_node in toposort:
                    ...
                    # Cannot use `copy.deepcopy` because that would also copy the Pytensor variables.
        ...
        # pytensor.dprint(fgraph, print_type=True)

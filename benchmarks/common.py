...
This module provides shared model builders and helpers used across
multiple benchmark files. We define them here instead of importing
from tests/ to avoid pulling in pytest as a dependency.
"""
...
def create_radon_model(
    ...
    """Build a radon model graph for benchmarking compilation and execution.

    Mirrors tests/fixtures.py::create_radon_model without requiring pytest.
    """
